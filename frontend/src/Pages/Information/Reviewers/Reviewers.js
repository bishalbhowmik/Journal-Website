...
const Reviewers = () => {
    return (
        <div className='max-w-[70%] mx-auto p-5'>
            <div>
                <h3 className='text-2xl font-semibold text-center underline underline-offset-8'>For reviewers
                </h3>

                <p className='text-lg my-4'>Benefits for Reviewers
                </p>
            ...
            <div>
                <p className='text-lg my-4'>Frequently asked questions
                </p>
